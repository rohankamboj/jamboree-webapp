...
import AppBarContent from 'src/@core/components/common/navbar/AppBarContent'
...
const UserLayout = ({ contentHeightFixed }: Props) => {
  ...
  let hideSidebarOnCoursePage: boolean = false

  if (location.pathname === '/course') {
    hideSidebarOnCoursePage = true
  }
  // return null

  return (
    <Layout
      hidden={hidden || hideSidebarOnCoursePage}
      settings={settings}
