...
import { getSectionIdFromNavItemPath } from 'src/@core/layouts/utils'
...
// ** Styled Components
const MenuNavLink = styled(Link)<LinkProps>(({ theme }) => ({
  display: 'flex',
  alignItems: 'center',
  textDecoration: 'none',
  width: '100%',
...
const VerticalNavLink = ({
  ...
  const isNavLinkActive = () => {
    const CurrentNavItemSectionId = getSectionIdFromNavItemPath(item.path)
    if (pathname === item.path || CurrentNavItemSectionId === sectionIdFromUrl) {
